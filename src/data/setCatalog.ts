...
export const CURRENT_GLOBAL_SET_CATALOG: readonly GlobalSetDefinition[] = [
  { id: "hawkwing", name: "Hawkwing", family: "weapon-accessory", numericalAvailability: "reference-only", provenance: `${PO_SWITCH_SET_FIXTURE}; ${REPO_EFFECT_EVIDENCE}`, stat2pc: { aff: 3.7 }, desc2pc: "2/4: +3.7% Affinity Rate", desc4pc: "4/4 effect retained as reference only; no event-uptime model is verified." },
  { id: "starweave", name: "Starweave", family: "weapon-accessory", numericalAvailability: "modeled", provenance: `${PO_SWITCH_SET_FIXTURE}; current Global tooltip evidence in the accepted baseline`, stat2pc: { minOuter: 78 }, desc2pc: "2/4: Min Physical ATK +78", desc4pc: "4/4: modeled only for the verified five-stack Martial Art Skill component." },
  { id: "jadeware", name: "Jadeware", family: "weapon-accessory", numericalAvailability: "modeled", provenance: `${PO_SWITCH_SET_FIXTURE}; ${REPO_EFFECT_EVIDENCE}`, stat2pc: { maxOuter: 64 } },
  { id: "rainwhisper", name: "Rainwhisper", family: "weapon-accessory", numericalAvailability: "modeled", provenance: `${PO_SWITCH_SET_FIXTURE}; ${REPO_EFFECT_EVIDENCE}`, stat2pc: { prec: 6.6 } },
  { id: "cleftpeak", name: "Cleftpeak", family: "weapon-accessory", numericalAvailability: "unavailable", provenance: PO_SWITCH_SET_FIXTURE },
  { id: "mistwillow", name: "Mistwillow", family: "weapon-accessory", numericalAvailability: "reference-only", provenance: `${PO_SWITCH_SET_FIXTURE}; ${REPO_EFFECT_EVIDENCE}`, stat2pc: { prec: 6.6 } },
  { id: "ivorybloom", name: "Ivorybloom", family: "weapon-accessory", numericalAvailability: "modeled", provenance: `${PO_SWITCH_SET_FIXTURE}; ${REPO_EFFECT_EVIDENCE}`, stat2pc: { crit: 7.4 } },
  { id: "swallowcall", name: "Swallowcall", family: "weapon-accessory", numericalAvailability: "modeled", provenance: `${PO_SWITCH_SET_FIXTURE}; ${REPO_EFFECT_EVIDENCE}`, stat2pc: { minOuter: 64 } },
  { id: "etherwrath", name: "Etherwrath", family: "weapon-accessory", numericalAvailability: "unavailable", provenance: PO_SWITCH_SET_FIXTURE },
  { id: "swift-gale", name: "Swift Gale", family: "weapon-accessory", numericalAvailability: "reference-only", provenance: `${PO_SWITCH_SET_FIXTURE}; ${REPO_EFFECT_EVIDENCE}`, stat2pc: { maxOuter: 64 } },
  { id: "swaying-heights", name: "Swaying Heights", family: "weapon-accessory", numericalAvailability: "modeled", provenance: `${PO_SWITCH_SET_FIXTURE}; ${REPO_EFFECT_EVIDENCE}`, stat2pc: { minOuter: 64 } },
  { id: "tiltrim", name: "Tiltrim", family: "weapon-accessory", numericalAvailability: "unavailable", provenance: `${PO_SWITCH_SET_FIXTURE}; official Global Version 2.1 update establishes current Bamboocut-Draught availability, but no effect values were supplied` },
