...
const newDeps = `  }, [adjustedPanel, activeTier, datang, yishui, selectedBuild, baselineScore, rotationStats.gradRate, rotationStats.totalDmg, selectedInnerWays, innerWayTiers]);`;
...
console.log("[t96-stat-priority] PASS — marginal stat value uses the same Bamboocut combat timeline as optimizer ranking.");
